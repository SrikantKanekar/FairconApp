package com.example.faircon.framework.datasource.network.connectivity
...
class ConnectionLiveData(context: Context) : LiveData<Boolean>() {
    ...
    private fun createNetworkCallback() = object : ConnectivityManager.NetworkCallback() {
        ...
        override fun onAvailable(network: Network) {
            ...
            printLogD("ConnectionLiveData", "onAvailable: ${network}, $hasInternetCapability")
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    if (hasInternet) {
                        withContext(Dispatchers.Main) {
                            printLogD("ConnectionLiveData", "onAvailable: adding network. $network")
        ...
        override fun onLost(network: Network) {
            printLogD("ConnectionLiveData", "onLost: $network")
