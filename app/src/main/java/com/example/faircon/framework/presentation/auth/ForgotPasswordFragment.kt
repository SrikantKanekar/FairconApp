...
import com.example.faircon.framework.presentation.auth.ForgotPasswordFragment.WebAppInterface.OnWebInteractionCallback
...
class ForgotPasswordFragment: BaseAuthFragment(R.layout.fragment_forgot_password) {
    ...
    private fun loadPasswordResetWebView(){
        ...
        webView.loadUrl(Urls.PASSWORD_RESET_URL)
