...
import com.example.faircon.ui.auth.ForgotPasswordFragment.WebAppInterface.OnWebInteractionCallback
...
class ForgotPasswordFragment: BaseAuthFragment(R.layout.fragment_forgot_password) {
    ...
    private val webInteractionCallback = object: OnWebInteractionCallback {
        ...
        override fun onError(errorMessage: String) {
            Log.e(Constants.TAG, "onError: $errorMessage")
        ...
        override fun onSuccess(email: String) {
            Log.d(Constants.TAG, "onSuccess: a reset link will be sent to $email.")
            onPasswordResetLinkSent()
        }

        override fun onLoading(isLoading: Boolean) {
            Log.d(Constants.TAG, "onLoading... ")
